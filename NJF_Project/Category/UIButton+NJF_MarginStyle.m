...
@implementation UIButton (NJF_MarginStyle)
...
- (void)NJF_imagePositionStyle:(NJF_ButtonEdgeInsetsStyle)imagePositionStyle spacing:(CGFloat)spacing imagePositionBlock:(void (^)(UIButton *button))imagePositionBlock{
    ...
    if (imagePositionStyle == NJF_ButtonEdgeInsetsStyleLeft) {
    ...
    } else if (imagePositionStyle == NJF_ButtonEdgeInsetsStyleRight) {
    ...
    } else if (imagePositionStyle == NJF_ButtonEdgeInsetsStyleTop) {
    ...
    } else if (imagePositionStyle == NJF_ButtonEdgeInsetsStyleBottom) {
        CGFloat imageW = self.imageView.frame.size.width;
        CGFloat imageH = self.imageView.frame.size.height;
        CGFloat titleIntrinsicContentSizeW = self.titleLabel.intrinsicContentSize.width;
        CGFloat titleIntrinsicContentSizeH = self.titleLabel.intrinsicContentSize.height;
